...
df_NoSchool = pd.read_excel('Children_Not_School.xlsx')

# Employment and Finance #
df_Finances = pd.read_excel('Monthly_Finances.xlsx')
df_FinancialSecurity = pd.read_excel('Financial_Security.xlsx')

# Energy Access #
df_EnergySources = pd.read_excel('Electricity_Source.xlsx')
df_EnergySatisfaction = pd.read_excel('Energy_Satisfaction.xlsx')
df_Appliances = pd.read_excel('Household_Appliances.xlsx')
df_LightSource = pd.read_excel('Lighting_Source.xlsx')

# Tarif and Services #
df_CostSatisfaction = pd.read_excel('Cost_Satisfaction.xlsx')
df_PaymentMethod = pd.read_excel('PaymentMethod_Satisfaction.xlsx')
df_satisfaction = pd.read_excel('Recommendation_Likelihood.xlsx')

# Women Empowerment #
df_WomenFreetime = pd.read_excel('Womens Freetime.xlsx')
df_WomenIndependance = pd.read_excel('Women_Independance.xlsx')
df_WomenRespectHOME = pd.read_excel('Respect_Household.xlsx')
df_WomenRespectCOMM = pd.read_excel('Respect_Community.xlsx')
df_HomeSecurity = pd.read_excel('HouseholdSecurity.xlsx')
#......................FUNCTIONS...............................................
# Health and Education #
