...
def download_file_from_bucket_tech(blob_name):
    try:
...
#====================TECHINCAL=============================================
#......................DATAFRAMES..............................................
power = download_file_from_bucket_tech("Power.csv")
energy = download_file_from_bucket_tech("EnergyBalance.csv")
# ============================================================================================= WIP ================================================================================
...
# DEFINE FUNCTION TO DOWNLOAD FILES (SOCIAL)
def download_file_from_bucket_soci(blob_name):
    try:
        storage_client = storage.Client()
        bucket = storage_client.bucket("dashboard_data_bucket")
        blob = bucket.blob(blob_name)
        ...
        return df
    except Exception as e: # If unable raise exception error
        print(e)
        return False

df_NoSchool = download_file_from_bucket_soci("Children_Not_School.xlsx")

# Employment and Finance # download_file_from_bucket_soci("HouseholdSecurity.xlsx")
df_Finances = download_file_from_bucket_soci("Monthly_Finances.xlsx")
df_FinancialSecurity = download_file_from_bucket_soci("Financial_Security.xlsx")

# Energy Access #
df_EnergySources = download_file_from_bucket_soci("Electricity_Source.xlsx")
df_EnergySatisfaction = download_file_from_bucket_soci("Energy_Satisfaction.xlsx")
df_Appliances = download_file_from_bucket_soci("Household_Appliances.xlsx")
df_LightSource = download_file_from_bucket_soci("Lighting_Source.xlsx")

# Tarif and Services #
df_CostSatisfaction = download_file_from_bucket_soci("Cost_Satisfaction.xlsx")
df_PaymentMethod = download_file_from_bucket_soci("PaymentMethod_Satisfaction.xlsx")
df_satisfaction = download_file_from_bucket_soci("Recommendation_Likelihood.xlsx")

# Women Empowerment #
df_WomenFreetime = download_file_from_bucket_soci("Womens_Freetime.xlsx")
df_WomenIndependance = download_file_from_bucket_soci("Women_Independance.xlsx")
df_WomenRespectHOME = download_file_from_bucket_soci("Respect_Household.xlsx")
df_WomenRespectCOMM = download_file_from_bucket_soci("Respect_Community.xlsx")
df_HomeSecurity = download_file_from_bucket_soci("HouseholdSecurity.xlsx")
#......................FUNCTIONS...............................................
# Health and Education #
