...
def render_page_content(pathname):
    if pathname == "/":
        ...
        oauth2() # OAUTH2 verification process as bearer token expires every 5 minutes (SMA sunny portal)
        return [
                html.Div(
                ...
                dcc.Tab(label='Total power of PV systems', value='tab-2'),
...
def render_tech_tabs_1(tab): # ======================================================================================================================= WIP ======================================================= #
    if tab == 'tab-1':
        return html.Div([
                ...
                start_date=date(C_year, C_month, C_day-12),
