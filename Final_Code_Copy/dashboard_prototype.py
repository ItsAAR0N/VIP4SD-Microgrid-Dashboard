...
def displayTotalGeneration():
    if C_month < 10:
       rgen = "https://async-auth.smaapis.de/monitoring/v1/plants/5340310/measurements/sets/EnergyBalance/Month?Date={0}-0{1}&WithTotal=false".format(C_year,C_month)
    else:
       rgen = "https://async-auth.smaapis.de/monitoring/v1/plants/5340310/measurements/sets/EnergyBalance/Month?Date={0}-{1}&WithTotal=false".format(C_year,C_month)
    headers2 = {'Host':'smaapis.de','Content-Type': 'application/json','Authorization':'Bearer {0}'.format(refreshtoken(r1))}
    ...
    TotalConsumptionDisplay = TotalConsumptionDisplay/1000
...
def render_page_content(pathname):
    if pathname == "/":
        ...
        return [
                ...
                html.Hr(),
                html.H3("The total power generated thus far in this month is {0} kWh".format(displayTotalGeneration())),
                html.P("Techincal data relating the to the functionality of the generation and distribution systems, a variety of data on technical performance is being collected through remote monitoring of the PV, batteries and inverters, along with measurements and observations of the system collected through scheduled maintenance visits on site."),
                ...
                dcc.Tab(label='WIP', value='tab-1'),
                dcc.Tab(label='WIP', value='tab-2'),
                ],),
...
def render_tech_tabs_1(tab): # ======================================================================================================================= WIP ======================================================= #
    if tab == 'tab-1':
        ...
        return html.Div([ 
                ...
                html.P("This is another key data indicator to track as it allows for one to come to conclusions regarding when the charge of the batteries are charged, or depleted. Again, note the anomolous data display between 23rd to 25th. All data is being drawn in from the SMA Sunny Portal API."),
