...
def render_page_content(pathname):
    if pathname == "/":
        ...
        return [
                ...
                html.Hr(),
                html.H3("The total power generated for the last 30 days is {0} kWh".format(0)),
                html.P("Techincal data relating the to the functionality of the generation and distribution systems, a variety of data on technical performance is being collected through remote monitoring of the PV, batteries and inverters, along with measurements and observations of the system collected through scheduled maintenance visits on site."),
                ...
                dcc.Tab(label='Total Consumption', value='tab-1'),
...
def render_tech_tabs_2(tab):
    if tab == 'tab-1':
        ...
        return html.Div([
                ...
                dcc.Graph(id='holder_graph_1', figure={}),
...
# GET DATA VIA LOOP
       ...
       fig.update_layout(
                    title ='Total Generation of Microgrid (Plant {0}):'.format(data_initial['plants'][0]['plantId']),
                    xaxis_title='Hours',
...
def TotalGenerationMonth(slct_user_2): 
    ...
    fig.update_layout(
                    title ='Total Generation (Plant {0}):'.format(data_initial['plants'][0]['plantId']),
                    xaxis_title='Months',
