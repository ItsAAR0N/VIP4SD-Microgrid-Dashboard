...
# STEP 3 - GET DATA VIA API FOR EXAMPLE
r = "https://async-auth.smaapis.de/monitoring/v1/plants/9209949/measurements/sets/EnergyBalance/Total?WithTotal=true"
headers2 = {'Host':'smaapis.de','Content-Type': 'application/json','Authorization':'Bearer {0}'.format(function(r1))}
...
# STEP 3 - GET DATA VIA API FOR EXAMPLE
if C_month < 10:
       r3 = "https://async-auth.smaapis.de/monitoring/v1/plants/9209949/measurements/sets/EnergyBalance/Month?Date={0}-0{1}&WithTotal=false".format(C_year,C_month)
else:
       r3 = "https://async-auth.smaapis.de/monitoring/v1/plants/9209949/measurements/sets/EnergyBalance/Month?Date={0}-{1}&WithTotal=false".format(C_year,C_month)
headers2 = {'Host':'smaapis.de','Content-Type': 'application/json','Authorization':'Bearer {0}'.format(function(r1))}
...
""" for i in range(1,12):
       if i < 10: # If date less than 10 to suit YYYY-MM-DD Format
              r = "https://async-auth.smaapis.de/monitoring/v1/plants/9209949/measurements/sets/EnergyBalance/Month?Date={0}-{1}&WithTotal=false".format(2021,i)
       else:
             r = "https://async-auth.smaapis.de/monitoring/v1/plants/9209949/measurements/sets/EnergyBalance/Month?Date={0}-{1}&WithTotal=false".format(2021,i) """

r = "https://async-auth.smaapis.de/monitoring/v1/plants/9209949/measurements/sets/EnergyBalance/Year?Date={0}&WithTotal=false".format(2021)
...
r = "https://async-auth.smaapis.de/monitoring/v1/plants/9209949/measurements/sets/EnergyBalance/Day?Date=2022-02-20&WithTotal=false"
headers2 = {'Host':'smaapis.de','Content-Type': 'application/json','Authorization':'Bearer {0}'.format(function(r1))}
...
""" r = "https://async-auth.smaapis.de/monitoring/v1/plants/9209949/logs?From=2020-06-05&To=2022-02-19&Level=Info"
...
for i in range(1,C_day):
       if i < 10: # If date less than 10 to suit YYYY-MM-DD Format
              r = "https://async-auth.smaapis.de/monitoring/v1/plants/9209949/measurements/sets/EnergyBalance/Day?Date=2022-01-0{0}&WithTotal=true".format(i)
       else:
              r = "https://async-auth.smaapis.de/monitoring/v1/plants/9209949/measurements/sets/EnergyBalance/Day?Date=2022-01-{0}&WithTotal=true".format(i)
...
r = "https://async-auth.smaapis.de/monitoring/v1/plants/9209949/measurements/sets/EnergyBalance/Recent?WithTotal=true"
headers2 = {'Host':'smaapis.de','Content-Type': 'application/json','Authorization':'Bearer {0}'.format(TOKEN)}
r = session.get(r,headers=headers2)
print("\nStatus Code: {0}. Successful: {1}\n".format(r.status_code,success(r.status_code)))
data_test = r.json()
...
# GET DATA VIA LOOP
       ...
       for i in range(int(start_date[8:10]),int(end_date[8:10])):
              if i < 10: # If date less than 10 to suit YYYY-MM-DD Format
                     r = "https://async-auth.smaapis.de/monitoring/v1/plants/9209949/measurements/sets/EnergyBalance/Day?Date={0}-{1}-0{2}&WithTotal=true".format(start_date[0:4],start_date[5:7],i)
              else:
                     r = "https://async-auth.smaapis.de/monitoring/v1/plants/9209949/measurements/sets/EnergyBalance/Day?Date={0}-{1}-{2}&WithTotal=true".format(start_date[0:4],start_date[5:7],i)
