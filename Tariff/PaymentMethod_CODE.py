...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 19 10:41:59 2022
...
# DATAFRAME # 
df_satisfaction = pd.read_excel('PaymentMethod_Satisfaction.xlsx')
...
plotly.offline.plot(fig_satisfaction, filename = 'PaymentMethod.html')