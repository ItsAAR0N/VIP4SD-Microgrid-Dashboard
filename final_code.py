...
header = {'Authorization': 'Token 77784f1a3afe5f235988cdad904e7cbb77ff5da9'}
...
def render_page_content(pathname):
    if pathname == "/":
        ...
        return [
                ...
                html.Hr(),
                html.P("The technical data is vitally important in order to enable close remote monitoring of the microgrid. This enables analysis of how efficiently the system is operating and if there are any issues or causes for concern. Furthermore, this data has the potential to enable early detection of faults or anomalies which could help prevent complete system failure. Analysis of this data could also be useful for gaining insight into how well the size of the system is suited for the village and, hence, could help with the design of similar microgrid systems in the future."),
                html.Hr(),
        ...
        return [
                ...
                html.Hr(),
                html.P("The social impact data is vitally important in order to enable analysis of both the short and long-term impact that the addition of a microgrid system has on the people within a village which had no previous access to power. The analysis of this data enables insight into how the microgrid has improved and/or worsened people’s lives and how their satisfaction with the system varies over time - both in terms of the tariff system and also the service - along with how how their access to energy has changed as a result of the microgrid. Furthermore, this data has the potential to provide further insight into how granting access to sustainable and reliable energy affects important factors such as health and education, employment and finance, and women empowerment."),
                html.Hr(),
...
def render_social_tabs(tab):
    if tab == 'tab-1':
        return html.Div([
                ...
                dcc.Graph(id='holder_graph_1', figure=holder_fig),
                html.P("Monitoring factors related to health is essential as it enables researchers to understand whether customer access to health information has improved. Improvement on this leads to improved knowledge as it raises awareness on the most common illnesses and diseases that people may be exposed to so that stakeholders can make informed decisions on how to prevent such things. This involves greater knowledge on factors such as improved sanitation, appropriate vaccinations, and how/when to get help. If analysis of this area indicates that customers don’t have much knowledge on this area then researchers can implement educational methods to improve these."),
                html.P("It is important to monitor factors related to education because better-quality education and increased hours of studying at home will support children and adults in enhancing their knowledge, resulting in them meeting minimum proficiency standards which in turn, generates more opportunities for them. Enhancing knowledge and meeting these minimum proficiency standards is essential as it enables socioeconomic mobility which is vital in the challenge of escaping poverty. In addition, ensuring that customers have a basic understanding of electricity and energy concepts is crucially important for efficient use, as well as ensuring safety is a key priority."),
                html.Hr(),
                ])
    elif tab == 'tab-2':
        return html.Div([
                ...
                dcc.Graph(id='holder_graph_1', figure=holder_fig),
                html.P("Gathering data on employment and finance is essential as it enables researchers, funders, and stakeholders to understand the economic impact that the microgrid has on individual households, and the community as a whole."),
                html.P("Monitoring employment is important because it provides key information on whether the microgrid is able to provide opportunity for new jobs to be created and whether current jobs, such as farming, can be improved through electrification which in turn, can reduce labour time and improve productivity."),
                html.P("Understanding whether customers have had an increase/decrease in household income and expenditure is essential because it then allows for more detailed research into what people are spending more or less money on, and why this is happening. For example, if households have been able to gain some additional income from the microgrid, does this result in them spending more on electricity because they now have the resources and capability to do so? Gaining a thorough understanding of these factors then enable the business model to be informed which can be implemented onto future microgrids."),
                html.Hr(),
                ])
    elif tab == 'tab-3':
        return html.Div([
                ...
                dcc.Graph(id='holder_graph_1', figure=holder_fig),
                html.P("The main target of SDG7 is to ensure access to affordable, reliable, sustainable, and modern energy for all. To achieve this, it’s important to ensure that customers are making the transition from using traditional, more harmful methods of cooking and lighting, to more sustainable methods. This includes factors such as the amount of cooking fuel (i.e., wood, charcoal) people are using, and the number of times they are having to collect this. If it is indicated that factors such as these are decreasing, then this indicates that there is a positive social impact happening. Alternatively, if factors such as these are being affected negatively, then researchers can find out why and in turn, implement appropriate methods to change this."),
                html.Hr(),
                ])
    elif tab == 'tab-4':
        return html.Div([
                ...
                dcc.Graph(id='holder_graph_1', figure=holder_fig),
                html.P("Indicators related to the tariff and service should be monitored because it indicates how satisfied customers are with the current tariffs that are in place, and the service that is provided. Monitoring this enables researchers to compare how much customers pay with how much they would like to pay, and adjustments can be made to the tariffs and business model, depending on their responses, which can be used for future microgrid projects in order to provide affordable energy to customers."),
                html.Hr(),
                ])
    elif tab == 'tab-5':
        return html.Div([
                ...
                dcc.Graph(id='holder_graph_1', figure=holder_fig),
                html.P("Another Sustainable Development Goal that this platform works towards is goal number 5, to achieve gender equality and empower all women and girls. Monitoring how women are impacted by the microgrid is essential because if there is more economically empowered women within these rural communities then more opportunities can be generated for them. Having more women in leadership roles, whether that is in their household or in the community, means that they will be empowered to gain both the economic and social power to move out of poverty and also readdresses the unequal gender attitudes that women often experience."),
                html.Hr(),
                ])
